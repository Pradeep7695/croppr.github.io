...
function revslider_showDoubleJqueryError(e) {
    ...
    function h(e, n) {
        ...
        e.parent().find(".tp-rightarrow").on(function() {
            if (n.transition == 0) {
        ...
        e.parent().find(".tp-leftarrow").on(function() {
            if (n.transition == 0) {
                n.next = n.next - 1;
                ...
                if (l.find("iframe").length > 0 || l.find("video").length > 0) {
                    ...
                    l.find("iframe").each(function() {
                        ...
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                            ...
                            l.find(".tp-thumb-image").on(function() {
                    ...
                    if (l.find("video").length > 0) {
                        l.find("video").each(function(n) {
                            ...
                            if (i.attr("control") == t && o.find(".tp-video-play-button").length == 0) {
                                ...
                                o.find(".tp-video-play-button").on(function() {
                                    if (o.hasClass("videoisplaying")) s.pause();
                                    else s.play()
                                })
                            }
                            if (i.attr("control") == t) {
                                o.find("video, .tp-poster").on(function() {
                                    if (o.hasClass("videoisplaying")) s.pause();
                                    else s.play()
                                })
                            }
    ...
    e.fn.extend({
        revolution: function(i) {
            ...
            return this.each(function() {
                var o = i;
                o.desktop = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|Flipmart 7)/i);
